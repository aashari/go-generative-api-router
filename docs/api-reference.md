...
**Base URL:**
- Production: `https://genapi.aduh.xyz`
- Development: `https://dev-genapi.aduh.xyz`
...
**Request:**
```bash
curl -X POST "https://genapi.aduh.xyz/v1/chat/completions?vendor=openai" \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
client = openai.OpenAI(
    ...
    base_url="https://genapi.aduh.xyz/v1"
)
...
const openai = new OpenAI({
    apiKey: 'your-api-key',
    baseURL: 'https://genapi.aduh.xyz/v1',
});
...
func main() {
    ...
    config.BaseURL = "https://genapi.aduh.xyz/v1"
